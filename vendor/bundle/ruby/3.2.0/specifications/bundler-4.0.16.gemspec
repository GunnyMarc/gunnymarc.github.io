...
Gem::Specification.new do |s|
  ...
  s.version = "4.0.16".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 3.4.1".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/ruby/rubygems/issues?q=is%3Aopen+is%3Aissue+label%3ABundler", "changelog_uri" => "https://github.com/ruby/rubygems/blob/master/CHANGELOG-bundler.md", "homepage_uri" => "https://bundler.io/", "source_code_uri" => "https://github.com/ruby/rubygems" } if s.respond_to? :metadata=
